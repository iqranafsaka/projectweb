    ...
    <div class="nav__holder nav--sticky">
      <div class="container relative">
        ...
        <div class="flex-parent">
          ...
          <!-- Logo -->
          <a href="/" class="logo">
            <img class="logo__img" src="{{ asset('assets/img/storage/logo_aboutfans.png')}}" style="width:150px" srcset="{{ asset('assets/img/storage/logo_aboutfans.png')}} 1x, {{ asset('assets/img/storage/logo_aboutfans.png')}} 2x" alt="logo">
          </a>
